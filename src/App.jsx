...
export default function App() {
  ...
  if (vista === 'LOGIN') { return ( <div className="container"><div className="login-card"><div className="header"><h1>Supertiendas Kamala</h1><small style={{color:'#ccc'}}>v39.0</small><p>Sistema de Control de Caja</p></div>
  ...
  // ... (RESTO DEL CÓDIGO IGUAL QUE V38) ...
